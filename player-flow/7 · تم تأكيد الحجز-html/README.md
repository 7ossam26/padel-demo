# 7 · تم تأكيد الحجز — design reference
...
- `Confirmed.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `Confirmed.dc.html`;
