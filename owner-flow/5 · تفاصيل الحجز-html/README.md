# 5 · تفاصيل الحجز — design reference
...
- `OwnerBookingDetail.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `OwnerBookingDetail.dc.html`;
