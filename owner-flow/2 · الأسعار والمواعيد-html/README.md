# 2 · الأسعار والمواعيد — design reference
...
- `OwnerSetup2.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `OwnerSetup2.dc.html`;
